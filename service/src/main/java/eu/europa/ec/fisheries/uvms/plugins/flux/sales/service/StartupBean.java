...
import eu.europa.ec.fisheries.uvms.plugins.flux.sales.service.bean.FileHandlerBean;
import eu.europa.ec.fisheries.uvms.plugins.flux.sales.service.mapper.ServiceMapper;
import eu.europa.ec.fisheries.uvms.plugins.flux.sales.service.producer.EventBusMessageProducerBean;
...
public class StartupBean extends PluginDataHolder {
    ...
    public void startup() {
        ...
        serviceType = ServiceMapper.getServiceType(
                ...
                getApplicationName(),
                "Plugin for sending and receiving data to and from FLUX for sales messages",
                PluginType.FLUX,
